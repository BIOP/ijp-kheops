...
public class OMETiffPyramidizerExporterNew<T extends NumericType<T>> {

	private static final Logger logger = LoggerFactory.getLogger(
		OMETiffPyramidizerExporterNew.class);
	...
	protected OMETiffPyramidizerExporterNew(
			...
			// Writing options
			WriterSettings writerSettings) throws Exception {
		// Monitoring
		...
		range = CZTRange.builder().setC(writerSettings.rangeC).setT(writerSettings.rangeT).setZ(writerSettings.rangeT).get(iniSizeC, iniSizeZ, iniSizeT);
