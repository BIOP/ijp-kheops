...
It is a tool targeted for [ImageJ/Fiji](https://imagej.net/software/fiji/). It can be installed through the [PTBIOP update site](https://wiki-biop.epfl.ch/en/ipa/fiji/update-site).
